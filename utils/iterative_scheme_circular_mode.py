"""
A circular mode version of the scheme which assumes circular boundary conditions instead of symmetric.
Given the first version of the code wasn't working for circular mode, I decided to use a separate file
to keep the original code readable.

Thank you to https://github.com/williamstern for pointing out the bug
"""
